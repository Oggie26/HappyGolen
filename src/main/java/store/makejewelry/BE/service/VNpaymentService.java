...
public class VNpaymentService {
    ...
    public String createUrl(RechargeRequestDTO rechargeRequestDTO) throws NoSuchAlgorithmException, InvalidKeyException, Exception{
        ...
        String tmnCode = "WAGG3WA7";
        String secretKey = "PNXAYRVIJ0Y6TXA6ARWVLNJEW9X1CDJD";
        String vnpUrl = " https://sandbox.vnpayment.vn/paymentv2/vpcpay.html";
        String returnUrl = "http://localhost:5173/success?orderId=" +rechargeRequestDTO.getOrderId() ;
        ...
        vnpParams.put("vnp_IpAddr", "159.223.64.244");
